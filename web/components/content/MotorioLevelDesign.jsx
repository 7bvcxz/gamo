  ...
  return (
    <>
      ...
      <p>
        ...
        <b>키</b>를 말하고 이유는 말하지 않는다. 화면 왼쪽 아래에 키캡 하나와 한 마디 —{' '}
        <code>이동</code> · <code>조사하기</code> · <code>안기</code> — 만 뜨고, 읽는 것이 아니라
        흘깃 보는 것으로 끝난다. (1.0.41 전에는 Grim의 머리 위에 떴다. 다른 안내와 같은 모서리로
        옮겨서 세계 한가운데를 세계에 돌려주었다.)
      </p>
      <p className="prop-why">
