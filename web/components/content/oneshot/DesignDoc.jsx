...
// markdown file to motorio-oneshot/design/ puts it on the site -- there is no
    ...
    return (
      <section className="prop">
        ...
        <p className="prop-why">
          <code>motorio-oneshot/design/</code> 에 파일이 있는지, 사이트 빌드가
      ...
      {doc.status && (
        <p className="design-status">
          ...
          <span className="design-source">
            원본: <code>motorio-oneshot/design/{doc.file}</code>
          </span>
        </p>
      )}
