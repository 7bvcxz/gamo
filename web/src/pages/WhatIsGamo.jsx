...
export function WhatIsGamo() {
  return (
    <>
      ...
      <h2>지금 있는 게임</h2>
      <div className="cards">
        <a className="card" href="/gamo/motorio-oneshot/">
        ...
        <a className="card" href="/gamo/motorio/">
          <b>Motorio</b>
          <span>
        ...
        <a className="card" href="/gamo/nowhere/">
          <b>Nowhere</b>
          <span>
      ...
      <p>
        ...
        <a href="/gamo/design/">설계 문서 뷰어</a>에서 볼 수 있으며, 저장소에 커밋된 원문을 그대로
