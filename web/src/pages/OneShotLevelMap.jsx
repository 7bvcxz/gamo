...
//
// Every radius, second and item value below is read from motorio-oneshot's
...
export function OneShotLevelMap() {
  return (
    <figure className="figure">
      <svg viewBox="0 0 960 860" role="img" aria-labelledby="lvlmap-t lvlmap-d">
        <title id="lvlmap-t">Motorio: One Shot 레벨 디자인 요약도</title>
        <desc id="lvlmap-d">
      ...
      <figcaption>
        모든 수치는 <code>motorio-oneshot/scripts/Defs.gd</code>에서 가져왔습니다.
      </figcaption>
    </figure>
  );
}
