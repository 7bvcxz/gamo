...
import './styles.css';
import { OBJECTS, ITEM_NAMES } from './graphics/objects.js';
    ...
    <div className="gfx-page">
      ...
      <div className="gfx-rules">
        ...
        <ol>
          ...
          <li>외곽선은 언제나 같은 검정에 가까운 색이다. 색은 정체성에 쓰고 윤곽에는 쓰지 않는다.</li>
      ...
      <div className="gfx-rules">
        ...
        <p>
          바꾸고 싶은 게 있으면 <a href="/gamo/motorio-oneshot/graphic/proposals/">그래픽 제안</a>{' '}
...
createRoot(document.getElementById('root')).render(<Graphic />);
