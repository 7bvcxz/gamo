...
// What has been decided about Motorio, what has not, and the argument that got
    ...
    <div className="gfx-page decisions">
      <header className="gfx-head">
        <p className="gfx-crumb">
          ...
          <a href={site('/motorio/doc/')}>Docs</a>
        </p>
        <h1>Decisions</h1>
        <p className="lede">
          Motorio에 대해 무엇이 정해졌고 무엇이 아직 열려 있는지, 그리고 거기에 이르기까지 오간
