...
import { LooproomPoc } from '../../../components/content/LooproomPoc.jsx';
...
const NAV = [
  {
    group: 'POC',
    items: [{ id: 'poc', label: '무엇을 확인하나', render: () => <LooproomPoc /> }],
  },
  {
    group: '링크',
    links: [
      { href: game('/looproom/'), label: '플레이 →' },
...
export default function Page() {
  return <DocShell brand="looproom" subtitle="POC" nav={NAV} home={game('/looproom/')} />;
}
