...
TILE_SHEETS = [
    ...
    ("tile_rock_20", "바위 · 모서리 조각 20장",
     "게임에서 사용 중입니다. 47장을 그리는 대신 사분면 조각 다섯 종을 네 방향으로 받아, 47가지 연결 경우를 코드로 조립합니다. 조각이 늘 같은 자리에서 만나므로 이음매가 어긋날 수 없습니다. 받은 20장 중 14장이 정확했고, 나머지는 정확한 SE 열을 돌려서 채웠습니다."),
