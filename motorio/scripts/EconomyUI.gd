...
func _draw() -> void:
	...
	if stage >= 3:
		draw_string(font, Vector2(16, 224 if stage == 3 else 242), "POWER %d   CHEESE %d" % [main_controller.electricity, main_controller.cheese], HORIZONTAL_ALIGNMENT_LEFT, 210, 11, Color("f1d86a"))
