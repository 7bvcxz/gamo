...
SHEETS = {
    ...
    # The first resource: ember stones, mined by hand in the opening minutes and
    # fed to the base for warmth. Generated by gen_tiles.py rather than bought,
    # which is why it is the only sheet here with a prompt behind it.
    "heatstone": ("tile_heatstone_6.png", "heatstone_6.png"),
